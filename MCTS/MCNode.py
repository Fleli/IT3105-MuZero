...
class MCNode():
    ...
    def biased_get_random_action(self, key) -> Action:
        # TODO: This is probably quite slow. Find better way to accomplish the same thing.
        weights = [ self.children[action].visits_to_self for action in self.actions ]
        return weighted_choice( weights, self.actions, key)
